...
description: Create a rigorous, editable, visually consistent 45-minute academic literature presentation from a paper PDF and optional supplementary materials. Use for deep journal-club presentations that require journal and author metadata, a complete scientific-problem narrative, detailed methods and statistical explanation, stepwise result interpretation, critical appraisal, reproducible code appendices, evidence tracking, and explicit implications for the user's own research.
---
...
- Main deck: 38–48 slides.
- Appendix: 5–15 slides.
- Slide ratio: 16:9 widescreen.
- Chinese font: Microsoft YaHei (微软雅黑).
- Overall style: restrained, journal-like, low-saturation, high readability, generous whitespace.
- Navigation: a persistent top navigation bar.
- References: concise source notes at the bottom of relevant slides where feasible.
...
| Introduction and gap | 6 min | 4–6 |
| Methods | 11 min | 8–12 |
| Results | 13 min | 12–16 |
| Discussion and appraisal | 6 min | 5–7 |
| Summary | 2 min | 1–2 |
| Implications for user's research | 2–4 min | 3–5 |
...
14. Quality control.
15. Instruments and measures.
16. Statistical analysis.
17. Results.
18. Discussion.
19. Methodological appraisal.
20. Limitations.
21. Summary.
22. Implications for the user's research.
23. References.
...
- the introduction forms one coherent scientific argument;
