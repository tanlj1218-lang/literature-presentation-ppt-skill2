...
def main() -> int:
    ...
    if not readme.exists():
        readme.write_text(
            ...
            "4. Track slide sources in `working/evidence-tracker.csv`.\n"
            "5. Track external literature in `working/literature-evidence-matrix.csv`.\n"
            "6. Save final deliverables in `outputs/`.\n",
            encoding="utf-8",
        )
