...
## 13. Mandatory Page-by-Page Visual Reference Generation

Before full production, prepare and approve four editable sample slides: title, introduction/theory, methods, and results. After the full page blueprint and style are approved, generate a distinct image2/image_gen full-slide visual reference for **every slide** in the main deck and appendix.

Each page reference must:

- express that page's specific scientific logic;
- preserve the approved visual DNA;
- show the intended hierarchy and reading path;
- reserve accurate space for source figures/tables;
- avoid invented statistics and charts;
- be suitable for element-level reconstruction.

Do not generate only the title page or reuse one generic image across the deck.

## 14. Image-to-PPT Native Reconstruction
...
- Reconstruct each slide against its own page-specific image2 reference.
